...
variable "AmiWin" {
  type = map(string)
  default = {
    us-east-1 = "ami-09048da831c68cc67" # Virginia
    us-east-2 = "ami-09048da831c68cc67" # Ohio
  }
  description = "I add only 3 regions (Virginia, Oregon, Ireland) to show the map feature but you can add all the regions that you need"
}
...
variable "winamis" {
  default = {
    us-east-1 = "ami-f494f19d"
    us-west-2 = "ami-09048da831c68cc67"
  }
}
variable "vpc_cidr" {
